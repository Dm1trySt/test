puts "Как я могу к вам обращаться?"
#ARGV - массив значений введенных в командную строку
# в нашем случае 0 - первый элемент массива
# т.е. в одной строке с командой "ruby name_programm.rb" нужно написать имя
#name = ARGV[0]
# name равен пустой строке для избежания ввода пустой строки пользователем
name = ""
while name == "" do
  name = gets.chomp
end
...
for elements in questions
  ...
  while (user_input != "да" and user_input != "нет")
    puts "Введите да или нет и нажвите ввод"
    #downcase - переводит все введенное пользователем в нижний регистр
    # "ДА".downcase == "да"
